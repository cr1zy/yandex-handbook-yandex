...
for student in range(N):
    name = input()
    if M == 0 or N < 3 or min(cw, sw, hw, tw) <= 0:
        Flag = True
    else:
        a = b = c = d = 0
    ...
    if Flag:
        ...
        elif top2_rating < rating < top1_rating:
            top3_rating, top2_rating, top1_rating = top2_rating, rating, top1_rating
            top3_rating_name, top2_rating_name, top1_rating_name = top2_rating_name, name, top1_rating_name
        elif top3_rating < rating < top2_rating:
            top3_rating = rating
            top3_rating_name = name
        pre_average_rating = pre_average_rating + rating
